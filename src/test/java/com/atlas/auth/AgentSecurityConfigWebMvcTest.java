...
class AgentSecurityConfigWebMvcTest {
    ...
    void observabilityAuditQueryShouldRequireAdminRole() throws Exception {
        ...
        mockMvc.perform(get("/api/agent/observability/top-tier/advanced-technology-compatibility-matrix")
                .header(HttpHeaders.AUTHORIZATION, "Bearer user-token"))
            .andExpect(status().isForbidden());
        ...
        mockMvc.perform(get("/api/agent/observability/top-tier/official-version-protocol-watch/vue-binding-spec")
                .header(HttpHeaders.AUTHORIZATION, "Bearer user-token"))
            .andExpect(status().isForbidden());
        ...
        mockMvc.perform(get("/api/agent/observability/top-tier/vue-workbench-migration-package")
                .header(HttpHeaders.AUTHORIZATION, "Bearer user-token"))
            .andExpect(status().isForbidden());
        ...
        mockMvc.perform(get("/api/agent/observability/memory-rag/eval-gate-contract")
                .header(HttpHeaders.AUTHORIZATION, "Bearer user-token"))
            .andExpect(status().isForbidden());
        ...
        mockMvc.perform(get("/api/agent/observability/eval/reviewed-trace-fixture-template")
                .header(HttpHeaders.AUTHORIZATION, "Bearer user-token"))
            .andExpect(status().isForbidden());
    ...
    public static class TestController {
        ...
        @GetMapping("/api/agent/observability/top-tier/advanced-technology-compatibility-matrix")
        String observabilityAdvancedTechnologyCompatibilityMatrix() {
            return "advanced-technology-compatibility-matrix";
        }
        ...
        @GetMapping("/api/agent/observability/top-tier/official-version-protocol-watch/vue-binding-spec")
        String observabilityOfficialVersionProtocolWatchVueBindingSpec() {
            return "official-version-protocol-watch-vue-binding-spec";
        }
        ...
        @GetMapping("/api/agent/observability/top-tier/vue-workbench-migration-package")
        String observabilityTopTierVueWorkbenchMigrationPackage() {
            return "top-tier-vue-workbench-migration-package";
        }
        ...
        @GetMapping("/api/agent/observability/memory-rag/eval-gate-contract")
        String observabilityMemoryRagEvalGateContract() {
            return "memory-rag-eval-gate-contract";
        }
        ...
        @GetMapping("/api/agent/observability/eval/reviewed-trace-fixture-template")
        String observabilityEvalReviewedTraceFixtureTemplate() {
            return "eval-reviewed-trace-fixture-template";
        }
