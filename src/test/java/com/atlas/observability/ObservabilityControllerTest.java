...
class ObservabilityControllerTest {
    ...
    private final AgentReviewedTraceFixtureHumanReviewGateService reviewedTraceFixtureHumanReviewGateService =
        new AgentReviewedTraceFixtureHumanReviewGateService(reviewedTraceFixtureHumanReviewPackageService);
    ...
    void evalWorkbenchOverview_shouldReturnFrontendReadModelForAdminUser() {
        ...
        assertThat(overview.traceSets()).allSatisfy(traceSet -> {
            ...
            assertThat(traceSet.reviewedFixtureHumanReviewGatePath()).contains("/workbench/trace-sets/");
            assertThat(traceSet.reviewedFixtureHumanReviewGatePath()).contains("/reviewed-fixture-human-review-gate");
    ...
    void evalWorkbenchCatalogPatchReview_shouldReturnGitReviewModelForAdminUser() {
        ...
        assertThat(review.reviewedFixtureReadiness())
            ...
            .containsEntry("currentTraceSetFailedQualityGates", java.util.List.of())
    ...
    @Test
    void reviewedTraceFixtureCandidate_shouldRequireAdminUserAndRejectUnknownTraceSet() {
        ResponseEntity<ApiResponse<AgentReviewedTraceFixtureCandidateResponse>> anonymous =
            controller.reviewedTraceFixtureCandidate("phase1-core-golden", null);
        ...
        ResponseEntity<ApiResponse<AgentReviewedTraceFixtureCandidateResponse>> user =
            controller.reviewedTraceFixtureCandidate("phase1-core-golden", null);
        ...
        ResponseEntity<ApiResponse<AgentReviewedTraceFixtureCandidateResponse>> missing =
            controller.reviewedTraceFixtureCandidate("missing-trace-set", null);

        assertThat(missing.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }

    @Test
    void reviewedTraceFixtureCandidate_shouldReturnReviewOnlyDraftForAdminUser() throws Exception {
        String traceId = "trc_c1111111111111111111111111111111";
        auditRecorder.record(new com.atlas.audit.AgentAuditEvent(
            "aud_eval_workbench_fixture_candidate",
            java.time.Instant.parse("2026-06-09T00:00:00Z"),
            traceId,
            "conv-sensitive",
            "user-sensitive",
        ...
        ResponseEntity<ApiResponse<AgentReviewedTraceFixtureCandidateResponse>> response =
            controller.reviewedTraceFixtureCandidate(
                "phase1-core-golden",
                new AgentEvalSuiteRequest(java.util.List.of(traceId, "secret-token-value"), null, null, null)
            );
        ...
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isNotNull();
        AgentReviewedTraceFixtureCandidateResponse candidate = response.getBody().getData();
        ...
        assertThat(candidate.privacy())
            ...
            .containsEntry("toolExecution", false)
            .containsEntry("kubeManagerCalls", false);
        assertThat(new com.fasterxml.jackson.databind.ObjectMapper().findAndRegisterModules().writeValueAsString(candidate))
    ...
    @Test
    void reviewedTraceFixtureCandidateWorkbench_shouldRequireAdminUserAndRejectUnknownTraceSet() {
        ResponseEntity<ApiResponse<AgentReviewedTraceFixtureCandidateWorkbenchResponse>> anonymous =
            controller.reviewedTraceFixtureCandidateWorkbench("phase1-core-golden", 50);
        ...
        ResponseEntity<ApiResponse<AgentReviewedTraceFixtureCandidateWorkbenchResponse>> user =
            controller.reviewedTraceFixtureCandidateWorkbench("phase1-core-golden", 50);
        ...
        ResponseEntity<ApiResponse<AgentReviewedTraceFixtureCandidateWorkbenchResponse>> missing =
            controller.reviewedTraceFixtureCandidateWorkbench("missing-trace-set", 50);

        assertThat(missing.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }

    @Test
    void reviewedTraceFixtureCandidateWorkbench_shouldAutoSelectDiscoveryCandidateForAdminUser() throws Exception {
        String traceId = "trc_d1111111111111111111111111111111";
        auditRecorder.record(new com.atlas.audit.AgentAuditEvent(
            "aud_eval_workbench_fixture_candidate_auto",
            java.time.Instant.parse("2026-06-09T00:00:00Z"),
            traceId,
            "conv-sensitive",
            "user-sensitive",
        ...
        ResponseEntity<ApiResponse<AgentReviewedTraceFixtureCandidateWorkbenchResponse>> response =
            controller.reviewedTraceFixtureCandidateWorkbench("phase1-core-golden", 50);

        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isNotNull();
        AgentReviewedTraceFixtureCandidateWorkbenchResponse workbench = response.getBody().getData();
        assertThat(workbench.schemaVersion()).isEqualTo("agent-reviewed-trace-fixture-candidate-workbench.v1");
        assertThat(workbench.workbenchStatus()).isEqualTo("READY_FOR_HUMAN_FIXTURE_REVIEW");
        assertThat(workbench.selectedCandidateTraceId()).isEqualTo(traceId);
        assertThat(workbench.candidateSelected()).isTrue();
        assertThat(workbench.readyForHumanGitReview()).isTrue();
        assertThat(workbench.readyForFixtureCommit()).isFalse();
        assertThat(workbench.candidateDiscovery().candidateTraceIds()).containsExactly(traceId);
        assertThat(workbench.candidatePreview().candidateFixtureDraft())
            .containsEntry("traceId", traceId)
            .containsEntry("requiresHumanGitReviewBeforeCommit", true)
            .containsEntry("readyForManifestQualityGateNow", false);
        assertThat(workbench.candidateDiscoverySummary())
            .containsEntry("rawAuditEmbedded", false)
            .containsEntry("autoSelectedFirstRecommendedCandidate", true);
        assertThat(workbench.workbenchPolicy())
    ...
    void reviewedTraceFixtureHumanReviewPackage_shouldBuildGitReviewPackageForAdminUser() throws Exception {
        ...
        assertThat(reviewPackage.endpointMap())
    ...
    @Test
    void reviewedTraceFixtureHumanReviewGate_shouldRequireAdminUserAndRejectUnknownTraceSet() {
        ResponseEntity<ApiResponse<AgentReviewedTraceFixtureHumanReviewGateResponse>> anonymous =
            controller.reviewedTraceFixtureHumanReviewGate("phase1-core-golden", 50, null);
        ...
        ResponseEntity<ApiResponse<AgentReviewedTraceFixtureHumanReviewGateResponse>> user =
            controller.reviewedTraceFixtureHumanReviewGate("phase1-core-golden", 50, null);
        ...
        ResponseEntity<ApiResponse<AgentReviewedTraceFixtureHumanReviewGateResponse>> missing =
            controller.reviewedTraceFixtureHumanReviewGate("missing-trace-set", 50, null);

        assertThat(missing.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }

    @Test
    void reviewedTraceFixtureHumanReviewGate_shouldValidateHumanFieldsWithoutRuntimeWrites() throws Exception {
        String traceId = "trc_d3333333333333333333333333333333";
        auditRecorder.record(new com.atlas.audit.AgentAuditEvent(
            "aud_eval_workbench_fixture_human_review_gate",
            java.time.Instant.parse("2026-06-09T00:00:00Z"),
            traceId,
            "conv-sensitive",
            "user-sensitive",
        ...
        SecurityContextHolder.getContext().setAuthentication(new TestingAuthenticationToken(
            "boss", null, "ROLE_SYS_ADMIN", "agent:observe"));
        AgentReviewedTraceFixtureHumanReviewGateRequest bootstrapRequest =
            new AgentReviewedTraceFixtureHumanReviewGateRequest(
                traceId,
        ...
        ResponseEntity<ApiResponse<AgentReviewedTraceFixtureHumanReviewGateResponse>> bootstrap =
            controller.reviewedTraceFixtureHumanReviewGate("phase1-core-golden", 50, bootstrapRequest);
        AgentReviewedTraceFixtureHumanReviewGateResponse bootstrapGate = bootstrap.getBody().getData();
        String candidateDigest = bootstrapGate.humanReviewPackage().candidateFixtureDraft()
            .get("candidateEvidenceDigest")
            .toString();

        ResponseEntity<ApiResponse<AgentReviewedTraceFixtureHumanReviewGateResponse>> response =
            controller.reviewedTraceFixtureHumanReviewGate(
                "phase1-core-golden",
                50,
                new AgentReviewedTraceFixtureHumanReviewGateRequest(
                    traceId,
                    ...
                    "2026-07-07T00:00:00Z",
                    candidateDigest,
                    bootstrapGate.expectedEvidenceDigest()
                )
            );

        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isNotNull();
        AgentReviewedTraceFixtureHumanReviewGateResponse gate = response.getBody().getData();
        assertThat(gate.schemaVersion()).isEqualTo("agent-reviewed-trace-fixture-human-review-gate.v1");
        assertThat(gate.gateStatus()).isEqualTo("READY_FOR_MANUAL_GIT_FIXTURE_COMMIT");
        assertThat(gate.selectedCandidateTraceId()).isEqualTo(traceId);
        assertThat(gate.readyForFixtureCommit()).isTrue();
        assertThat(gate.runtimeFixtureCommitAllowed()).isFalse();
        assertThat(gate.fieldResults()).allSatisfy(field -> assertThat(field)
            .containsEntry("valid", true)
            .containsEntry("runtimeCallable", false));
        assertThat(gate.manifestQualityGatePreview())
        ...
        assertThat(gate.privacy())
            ...
            .containsEntry("containsToken", false)
            .containsEntry("containsPassword", false);
        assertThat(new com.fasterxml.jackson.databind.ObjectMapper().findAndRegisterModules().writeValueAsString(gate))
