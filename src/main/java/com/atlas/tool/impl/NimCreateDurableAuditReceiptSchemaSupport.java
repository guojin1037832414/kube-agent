...
final class NimCreateDurableAuditReceiptSchemaSupport {
    ...
    private static boolean requestContractValid(Map<String, Object> auditContext,
        ...
        return !requestContract.isEmpty()
            ...
            && requiredFields.contains("storageAvailabilityProbeRequest")
            && requiredFields.contains("preWriteRecordTemplate")
            && requiredFields.contains("postWriteRecordTemplate")
    ...
    private static boolean responseContractValid(Map<String, Object> responseContract) {
        ...
        return !responseContract.isEmpty()
            ...
            && requiredFutureSuccessFields.contains("storageProbeReceipt")
            && requiredFutureSuccessFields.contains("preWriteDurableAck")
            && requiredFutureSuccessFields.contains("postWriteDurableAck")
            && requiredFutureSuccessFields.contains("durableReceipt")
