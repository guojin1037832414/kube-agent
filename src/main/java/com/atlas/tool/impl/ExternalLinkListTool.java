...
/**
 * 查询外部链接列表 Tool — 接入真实 kube-manager API。
 *
 * <p>意图映射: {@code intentId = "external_link_list"}</p>
 * <p>Agent归属: query | 安全级别: P3</p>
 * <p>API路径: GET /api/{orgId}/external-link</p>
 */
@Component
@AtlasToolMapping(
