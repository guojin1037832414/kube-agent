...
public record AgentVueReadinessControlPlaneResponse(
    ...
    private static List<Map<String, Object>> buildDashboards() {
        return List.of(
            ...
            dashboard("advanced-technology-compatibility-matrix-binding-spec", "READY_TO_BIND",
                "Render or test against the backend-owned Vue component, field, column, state, disabled-action, and fixture binding spec for the compatibility matrix.",
            ...
            dashboard("official-version-protocol-watch-dashboard", "READY_TO_BIND",
                "Render Vue-ready official source cards, technology track cards, gates, blocked shortcuts, and disabled runtime actions.",
                AgentOfficialVersionProtocolWatchDashboardResponse.DASHBOARD_ENDPOINT,
                List.of("sourceCards", "technologyTrackCards", "adoptionGateRows",
                    "blockedRuntimeShortcutRows", "disabledRuntimeActions", "renderSections")),
            dashboard("official-version-protocol-watch-binding-spec", "READY_TO_BIND",
                "Render or test against the backend-owned Vue component, field, column, state, disabled-action, and fixture binding spec.",
            ...
            dashboard("top-tier-vue-workbench-acceptance-contract", "READY_TO_BIND",
                "Render or test the Vue 2 / Element UI route, API, fixture, and absent-runtime-control acceptance contract before implementing the frontend pages.",
            ...
            dashboard("memory-rag-reviewed-trace-evidence-manifest", "READY_TO_BIND",
                "Render required Memory/RAG redacted trace fixtures, digest evidence, review workflow, and advanced technology mappings.",
                AgentMemoryRagReviewedTraceEvidenceManifestResponse.MANIFEST_ENDPOINT,
                List.of("requiredTraceSets", "evidenceIntakeSchema", "reviewWorkflow",
                    "advancedTechnologyMappings", "manifestPolicy")),
    ...
    private static List<Map<String, Object>> buildRequiredApiBindings() {
        return List.of(
            ...
            apiBinding("memory-rag-reviewed-trace-evidence-manifest",
                AgentMemoryRagReviewedTraceEvidenceManifestResponse.MANIFEST_ENDPOINT, "GET", true),
